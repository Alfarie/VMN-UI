...
export const _setTask = task => async (dispatch: Function, getState: Function) => {
  ...
  try {
    ...
    notification.open({
      ...
      description: `Add task on ch:${task.ch} for ${task.working} at ${task.datetime}`,
    })
  } catch (ex) {
    notification.open({
      type: 'fail',
...
const control = [
  {
    ...
    timer: {
      mode: 1,
      list: [[300, 120], [540, 120], [780, 120], [1020, 120]],
    },
    irrigation: {
      soil_upper: 60,
      soil_lower: 40,
  ...
  },
  {
    ...
    timer: {
      mode: 1,
      list: [[300, 120], [540, 120], [780, 120], [1020, 120], [1260, 120]],
    },
    irrigation: {
      soil_upper: 60,
      soil_lower: 40,
