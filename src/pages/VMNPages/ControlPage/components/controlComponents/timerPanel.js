...
import { Form, TimePicker, Button, InputNumber, Icon, Modal } from 'antd'
            ...
            return (
                <li key={key}
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <span style={{ fontSize: '14px' }}>{this.minToTime(timer[0])} - {timer[1]} Sec. </span>
                        <span>
                            <Button type="primary" shape="circle" icon="tool" onClick={(e) => this.setState({visible: true, listNumber: ind, working: +timer[1]}) } />
                            <Button style={{marginLeft: '10px'}} type="danger" shape="circle" icon="delete" onClick={(e) => { this.onDeleteTimer(ind) }} />
                        </span>
        ...
        return (
          <Fragment>
              <Modal
                ...
                onOk={() => {
                    var { control, ch, dispatch } = this.props
                    control[ch - 1].timer.list[this.state.listNumber][1] = this.state.working
                    dispatch(setControl(control, ch));
                ...
                <div className="card-body">
                    <Form onSubmit={this.onAddTimer}>
                        ...
                        <div className="d-flex justify-content-around" style={{marginTop: '15px'}}>
                            ...
                            <Button type="primary" icon="download" htmlType="submit" style={{marginTop: '5px'}}>Add</Button>
                        </div>
                    </Form>
