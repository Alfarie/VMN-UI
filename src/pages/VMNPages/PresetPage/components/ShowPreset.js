...
class ShowPreset extends React.Component {
            ...
            return (
                <li key={key}
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <Button type="danger" shape="circle" icon="delete" onClick={(e) => { this.deleteTime(ind) }} />
                    </div>
                </li>)
        })
    }
    ...
    addTimer = () => {
        ...
        newPreset[currentPreset - 1].data.timer.list.sort((a, b) => a[0] < b[0] ? -1 : a[0] > b[0] ? 1 : 0);
                    ...
                    <Form onSubmit={this.onHandleSubmit}>
                        ...
                        <div className="d-flex flex-row" style={{ marginBottom: '25px' }}>
                            <div style={{ marginRight: '10px' }}>
                                <TimePicker format="HH:mm" value={this.state.time} onChange={val => { this.setState({ time: val }) }} />
                            </div>
                            <div style={{ marginRight: '10px' }}>
                                <InputNumber
                                    min={1}
                                    ...
                                    onChange={val => { this.setState({ sec: val }) }}
                                />
                            </div>
                            <Button type="primary" icon="download" htmlType="button" style={{ marginRight: '10px' }} onClick={this.addTimer}>Add</Button>
                        </div>
