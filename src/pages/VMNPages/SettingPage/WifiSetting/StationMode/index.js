          ...
          <div className="card-body pb-0">
            ...
            <div className="d-flex justify-content-between">
              <RefreshButton
                type="default"
                title="Refresh Wi-Fi"
                loading={refreshLoding ? true : false}
                onSubmit={this.refreshWifi}
              />
              <RefreshButton
                type="primary"
                title="connect"
                htmlType="submit"
                loading={connectLoding ? true : false}
              />
            </div>
          </div>
        </Form>
...
const WrappedApMode = Form.create({})(ApMode)
